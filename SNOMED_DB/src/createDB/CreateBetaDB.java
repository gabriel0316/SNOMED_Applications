...
public class CreateBetaDB {

	// Driver needed to connect to the SNOMED database
	public static Connection conn = null;
	static String ReleaseFilePath = "PATH_TO_YOUR_INTERNATIONAL_EDITION"; // Path to the International Edition
	static String ReleaseFilePathCH = "PATH_TO_YOUR_SWISS_EXTENSION"; // Path to the Swiss Extension
	static String ReleaseDate = "20250401";
	static String ReleaseDateCH = "CH1000195_20250607";

	public static void main(String[] args) {
		// Datenbankverbindung konfigurieren
		String dbName = "SCT:CH_Beta_Juni25";
...
//		            System.out.println(createDBQuery);
			...
			connection = DriverManager.getConnection(dbURL + dbName + multiQueries + "&" + allowLoadLocalInfile, dbUser,
					dbPassword);
...
//		            System.out.println(createModuleDependencyRefsetTableQuery);
			...
			String importConceptsIntEdQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePath
					+ "\\\\Full\\\\Terminology\\\\sct2_Concept_Full_INT_" + ReleaseDate + ".txt'\r\n"
...
//		            System.out.println(importConceptsIntEdQuery);
			...
			String importDescriptionIntEdQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePath
					+ "\\\\Full\\\\Terminology\\\\sct2_Description_Full-en_INT_" + ReleaseDate + ".txt'\r\n"
...
//		            System.out.println(importDescriptionIntEdQuery);
			System.out.println(
					"Import SNOMED Interntaional Edition Release " + ReleaseDate + " descriptions successful!");

			String importRelationshipIntEdQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePath
					+ "\\\\Full\\\\Terminology\\\\sct2_Relationship_Full_INT_" + ReleaseDate + ".txt'\r\n"
...
//		            System.out.println(importRelationshipIntEdQuery);
			System.out.println(
					"Import SNOMED Interntaional Edition Release " + ReleaseDate + " relationships successful!");
...
//		            System.out.println(importSimpleRefsetIntEdQuery);
			...
			String importLanguageRefsetsIntEdQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePath
					+ "\\\\Full\\\\Refset\\\\Language\\\\der2_cRefset_LanguageFull-en_INT_" + ReleaseDate + ".txt'\r\n"
...
//		            System.out.println(importLanguageRefsetsIntEdQuery);
			System.out.println(
					"Import SNOMED Interntaional Edition Release " + ReleaseDate + " language refsets successful!");
...
//		            System.out.println(importExtendedMapRefsetsIntEdQuery);
			...
			String importConceptsCHdQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Concept_Snapshot_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_concept`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`definitionStatusId`);";
...
//		            System.out.println(importConceptsCHdQuery);
			...
			String importDescriptionDeCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Description_Snapshot-de-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		            System.out.println(importDescriptionDeCHQuery);
			...
			String importDescriptionFrCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Description_Snapshot-fr-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		            System.out.println(importDescriptionFrCHQuery);
			...
			String importDescriptionItCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Description_Snapshot-it-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		            System.out.println(importDescriptionItCHQuery);
			...
			String importDescriptionEnCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Description_Snapshot-en_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		            System.out.println(importDescriptionEnCHQuery);
			...
			String importRelationshipCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Terminology\\\\sct2_Relationship_Snapshot_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_relationship`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n" + " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`sourceId`,`destinationId`,`relationshipGroup`,`typeId`,`characteristicTypeId`,`modifierId`);";
...
//		            statement.executeUpdate(importSimpleRefsetCHQuery);
			...
			String importLanguageRefsetsDeCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Refset\\\\Language\\\\der2_cRefset_LanguageSnapshot-de-ch_" + ReleaseDateCH
					+ ".txt'\r\n" + "INTO TABLE `full_refset_Language`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`refsetId`,`referencedComponentId`,`acceptabilityId`);";
...
//		            System.out.println(importLanguageRefsetsDeCHQuery);
			...
			String importLanguageRefsetsFrCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Refset\\\\Language\\\\der2_cRefset_LanguageSnapshot-fr-ch_" + ReleaseDateCH
					+ ".txt'\r\n" + "INTO TABLE `full_refset_Language`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`refsetId`,`referencedComponentId`,`acceptabilityId`);";
...
//		            System.out.println(importLanguageRefsetsFrCHQuery);
			...
			String importLanguageRefsetsItCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Refset\\\\Language\\\\der2_cRefset_LanguageSnapshot-it-ch_" + ReleaseDateCH
					+ ".txt'\r\n" + "INTO TABLE `full_refset_Language`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`refsetId`,`referencedComponentId`,`acceptabilityId`);";
...
//		            System.out.println(importLanguageRefsetsItCHQuery);
			System.out
					.println("Import Swiss Extension Release " + ReleaseDate + " italian language refset successful!");

			String importLanguageRefsetsEnCHQuery = "LOAD DATA LOCAL INFILE '" + ReleaseFilePathCH
					+ "\\\\Snapshot\\\\Refset\\\\Language\\\\der2_cRefset_LanguageSnapshot-en_" + ReleaseDateCH
					+ ".txt'\r\n" + "INTO TABLE `full_refset_Language`\r\n" + "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`refsetId`,`referencedComponentId`,`acceptabilityId`);";
...
//		            System.out.println(importLanguageRefsetsEnCHQuery);
			System.out
					.println("Import Swiss Extension Release " + ReleaseDate + " english language refset successful!");
